...
const WishList = () => {
  ...
  const getWhishlistData = (tabEndpoint) => {
    ...
    if (getUser) {
      ...
      try {
        axios.post(`https://truck.truckmessage.com/${tabEndpoint}`, data)
          .then(response => {
            if (response.data.success && Array.isArray(response.data.data)) {
              setData(response.data.data);
              setGettingDetails(false)
    ...
    <div className='container'>
      <ul className="nav nav-tabs">
        <li className="nav-item">
          <NavLink to="/wishlist/load" className={"nav-link"} onClick={() => getWhishlistData('user_load_details')}>Load availability post</NavLink>
        </li>
        <li className="nav-item">
          <NavLink to="/wishlist/truck" className={"nav-link"} onClick={() => getWhishlistData('user_truck_details')}>Truck availability post</NavLink>
        </li>
        <li className="nav-item">
          <NavLink to="/wishlist/driver" className={"nav-link"} onClick={() => getWhishlistData('user_driver_details')}>Driver availability post</NavLink>
        </li>
        <li className="nav-item">
          <NavLink to="/wishlist/buy_sell" className={"nav-link"} onClick={() => getWhishlistData('user_buy_sell_details')}>Buy & Sell Post</NavLink>
        </li>
      </ul>
